...
First of all, when we have the "lyrics" dataset for the first time, we'd like to find out like how many songs this artist have sung and how many songs were in this genre in a certai period and so on.
...
2. in year 2006, the number of songs created in 8 genres reaches peak amount, respectively;
3. in year 2006-2008, the number of songs created in almost each genre is much more greater than other years;
4. the number of songs in genre Rock is greater than the number in any other genre in nearly each year, especially in year 2006-2008.
...
## Part 2. Which words they would love to use in period 2006-2008?
...
From the plot, we can see that dolly-parton preferred using shorter sentences compared with eddy and barbra. But they three all enjoyed to use shorter sentences.
...
And as we have seen before, much more songs belong to **genre Rock** than other genres, therefore, it is a good idea to analysis the data and find out **why many artists love Rock**.
...
3. bruce-springsteen's songs contains all the topics with almost same weight;
...
**In short**, people love Rock music maybe because it can contain a wide range of topics and they can express their feelings through this type of music easily and people can find their own stories by listening to the songs. As far as the rock songs I have listened, the rhythm is usually very fast so that it can make happy people happier and sad people more sad.
